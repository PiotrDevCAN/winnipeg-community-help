...
import icon1Logo from "@/assets/icon1.webp";
...
const Footer = () => {
  const { menuFooterData: data } = useAppMenus();
  ...
  return (
    <>
      <Row gutter={[16, 32]} align="middle" justify="space-between" wrap>
        ...
        >
          <a href="/">
            <img src={icon1Logo} alt="logo" style={{ width: "144px" }} />
          </a>
        </Col>
      ...
      <p style={{ textAlign: "center", fontSize: "14px", margin: "8px 0" }}>
        ...
        Nations. We acknowledge Manitoba is located on the Homeland of the Red
        River Métis.
      </p>
    </>
  );
