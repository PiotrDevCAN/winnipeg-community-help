...
const Header2 = () => {
    ...
    return (
        <header className='font-[sans-serif] min-h-[60px] tracking-wide relative z-50'>
            ...
            <section className='flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4'>
                <a href="/home"><img src="https://readymadeui.com/readymadeui-light.svg" alt="logo" className='w-36' />
                </a>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li className='mb-6 hidden max-lg:block'>
                                <a href="/home"><img src="https://readymadeui.com/readymadeui-light.svg" alt="logo"
                                    className='w-36' />
                                </a>
                            </li>
                            ...
                            {menuData.map((item) => (
                                <li key={item.name} className='max-lg:border-b max-lg:py-3 px-3'>
                                    <a href={item.href} className='text-gray-300 hover:text-white text-base flex items-center'>
                ...
                <div className='flex items-center max-sm:ml-auto'>
                    ...
                    <button id="toggleOpen" onClick={handleClick} className='lg:hidden ml-6'>
